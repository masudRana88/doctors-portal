    ...
    return (
        <div className='w-full mt-16'>
            ...
            <div className='grid grid-cols-1 px-4 mt-10 md:grid-cols-3 md:px-10 gap-7'>
                {
                    services.map(s=>(
                    <div className='flex items-center justify-center px-10 py-10 cursor-pointer md:px-32 rounded-2xl shadow-cardShadow hover:bg-slate-200' onClick={()=>setSlots(s)}>
