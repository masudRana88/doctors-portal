...
const DentalCare = () => {
    return (
        <section className='container flex flex-col h-full px-4 pt-10 mx-auto md:pt-16 md:flex-row'>
            <div className='flex items-center justify-center w-full md:w-2/4'>
                <img src={treatment} alt="" className='w-[322px] h-[4-8px] md:w-[458px] md:h-[576px] rounded-md'/>
            </div>
