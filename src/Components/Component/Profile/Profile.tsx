...
export default function Profile() {
  ...
  return (
    <div className='w-full h-full mx-auto'>
        <div className='p-5 mt-5 ml-5 mr-5 rounded-md shadow md:w-5/6 bg-slate-100'>
          <h4 className='mt-8 mb-10 text-2xl font-normal text-center'>My Profile</h4>
          <form onSubmit={handleSubmit} className="flex flex-col items-center justify-center">
            {/* Email */}
            <div className="w-9/12 mb-3 xl:w-96 md:w-10/12">
            ...
            <input type="submit" value="Update" className="mb-8 inline xl:w-96 md:w-10/12  w-9/12 px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out"/>
        </form>
        </div>
    </div>
  )
